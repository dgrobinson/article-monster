...
- Canonical plans: active plans in `docs/batches/anchor/*.md`, completed plans in `docs/plans/archived/01-anchor/*.md`.
...
1. Treat the orchestration repo as canonical for:
   - Active plans: `docs/batches/anchor/*.md`
   - Completed plans: `docs/plans/archived/01-anchor/*.md`
2. Compare each agent repo plan file to canonical (active or archived):
...
- Canonical plan docs in `docs/batches/anchor/` (active) and `docs/plans/archived/01-anchor/` (completed).
